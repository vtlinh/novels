-- schema of version 21, as onCreate builds it
...
CREATE TABLE IF NOT EXISTS novels (folder TEXT, slug TEXT, url TEXT, title TEXT, started INTEGER, total INTEGER DEFAULT -1, complete INTEGER DEFAULT 0, author TEXT DEFAULT '', disk_count INTEGER DEFAULT 0, last_dl INTEGER DEFAULT 0, last_read INTEGER DEFAULT 0, dir_name TEXT DEFAULT '', auto_dl INTEGER DEFAULT 0, translate INTEGER DEFAULT -1, resume_page INTEGER DEFAULT 0, resume_url TEXT DEFAULT '', resume_before INTEGER DEFAULT 0, alt_names TEXT DEFAULT '', genres TEXT DEFAULT '', source TEXT DEFAULT '', description TEXT DEFAULT '', status_label TEXT DEFAULT '', PRIMARY KEY(folder, slug));
