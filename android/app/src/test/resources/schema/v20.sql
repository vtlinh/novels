-- schema of version 20, as onCreate built it at commit c61997c
...
CREATE TABLE IF NOT EXISTS novels (folder TEXT, slug TEXT, url TEXT, title TEXT, started INTEGER, total INTEGER DEFAULT -1, complete INTEGER DEFAULT 0, author TEXT DEFAULT '', disk_count INTEGER DEFAULT 0, last_dl INTEGER DEFAULT 0, last_read INTEGER DEFAULT 0, dir_name TEXT DEFAULT '', auto_dl INTEGER DEFAULT 0, translate INTEGER DEFAULT -1, resume_page INTEGER DEFAULT 0, resume_url TEXT DEFAULT '', resume_before INTEGER DEFAULT 0, PRIMARY KEY(folder, slug));
