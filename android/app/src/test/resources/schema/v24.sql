-- schema of version 24, as onCreate builds it
...
CREATE TABLE IF NOT EXISTS chapter_image_req (folder TEXT, slug TEXT, chapter TEXT, hash TEXT DEFAULT '', thread_ts TEXT DEFAULT '', started_at INTEGER DEFAULT 0, PRIMARY KEY(folder, slug, chapter, thread_ts));
