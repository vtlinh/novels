-- schema of version 25, as onCreate builds it
...
CREATE TABLE IF NOT EXISTS chapter_image (folder TEXT, slug TEXT, chapter TEXT, image TEXT DEFAULT '', PRIMARY KEY(folder, slug, chapter));
