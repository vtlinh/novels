-- schema of version 14, as onCreate built it at commit 09e90c3
-- extracted by tools/extract-schemas.py; do not hand-edit
CREATE TABLE chapters (folder TEXT, slug TEXT, filename TEXT, uri TEXT, url TEXT DEFAULT '', PRIMARY KEY(folder, slug, filename));
