-- schema of version 5, as onCreate built it at commit 20aaad8
...
CREATE TABLE IF NOT EXISTS novels (folder TEXT, slug TEXT, url TEXT, title TEXT, started INTEGER, total INTEGER DEFAULT -1, complete INTEGER DEFAULT 0, PRIMARY KEY(folder, slug));
